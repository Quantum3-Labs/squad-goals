...
pub trait ISquadGoals<TContractState> {
    ...
    // view functions 
    fn get_challenge_stake_amount(self: @TContractState, challenge_id: u256) -> u256;
    fn get_challenge_staker_count(self: @TContractState, challenge_id: u256) -> u256;
    fn get_challenge_staker_by_id(self: @TContractState, challenge_id: u256, staker_id: u256) -> ContractAddress;
    fn get_challenge_deadline(self: @TContractState, challenge_id: u256) -> u256;
    fn get_challenge_has_joined(self: @TContractState, challenge_id: u256, staker: ContractAddress) -> bool;
    fn get_challenge_has_completed(self: @TContractState, challenge_id: u256) -> bool;
    fn get_challenge_balance(self: @TContractState, challenge_id: u256) -> u256;
...
use openzeppelin::access::ownable::OwnableComponent;
    ...
    impl ISquadGoalsImpl of ISquadGoals<ContractState> {
        ...
        fn get_challenge_stake_amount(self: @ContractState, challenge_id: u256) -> u256 {
            self.challenge_stake_amount.read(challenge_id)
        }
        fn get_challenge_staker_count(self: @ContractState, challenge_id: u256) -> u256 {
            self.challenge_staker_count.read(challenge_id)
        }
        fn get_challenge_staker_by_id(self: @ContractState, challenge_id: u256, staker_id: u256) -> ContractAddress {
            self.challenge_staker_by_id.read((challenge_id, staker_id))
        }
        fn get_challenge_deadline(self: @ContractState, challenge_id: u256) -> u256 {
            self.challenge_deadline.read(challenge_id)
        }
        fn get_challenge_has_joined(self: @ContractState, challenge_id: u256, staker: ContractAddress) -> bool {
            self.challenge_has_joined.read((challenge_id, staker))
        }
        fn get_challenge_has_completed(self: @ContractState, challenge_id: u256) -> bool {
            self.challenge_has_completed.read(challenge_id)
        }
        fn get_challenge_balance(self: @ContractState, challenge_id: u256) -> u256 {
        ...
        fn get_challenge_data(self: @ContractState, challenge_id: u256) -> (u256, u256, u256, bool) {
            let stake_amount = self.get_challenge_stake_amount(challenge_id);
            let staker_count = self.get_challenge_staker_count(challenge_id);
            let deadline = self.get_challenge_deadline(challenge_id);
            let has_completed = self.get_challenge_has_completed(challenge_id);
